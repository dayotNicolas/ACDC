...
with open(MainCsvFilePath) as csvFile:
    ...
    for row in csvReader:
        ...
        if (
            re.search(
                "donnees-relatives-aux-personnes-vaccinees-contre-la-covid-19-1.*vacsi-v-dep",
                row[9],
            )
            is not None
        ):
        ...
        if (
            re.search(
                "donnees-relatives-aux-personnes-vaccinees-contre-la-covid-19-1.*vacsi-v-fra",
                row[9],
            )
            is not None
        ):
        ...
        if (
            re.search(
                "donnees-hospitalieres-relatives-a-lepidemie-de-covid-19.*covid-hosp-ad-age",
                row[9],
            )
            is not None
        ):
        ...
        if (
            re.search(
                "donnees-de-vaccination-relatives-aux-professionnels-et-resident-en-ehpad-et-usld.*vacsi-prof-dep",
                row[9],
            )
            is not None
        ):
        ...
        if (
            re.search(
                "donnees-de-certification-electronique-des-deces-associes-au-covid-19-cepidc.*covid-cedc-quot",
                row[9],
            )
            is not None
        ):
